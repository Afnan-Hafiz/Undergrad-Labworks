...
Original file is located at
    https://colab.research.google.com/drive/1MlbSIEAWma1_Tfgd3R9jF-WfE3JDQCnb
...
ax.axhline(y=0, color='k')
hs = np.array([3.5, 0.55, 0.3, .17, 0.1, 0.055, 0.03, 0.017, 0.01])
e1, e2 = error_2(p, hs, 2.75)
e3, e4, e5 = error_1(p, p_prime, hs, x)
ax.plot(hs, e1, label='dh')
ax.plot(hs, e2, label='dh1')
ax.plot(hs, e3, label='forward')
ax.plot(hs, e4, label='backward')
ax.plot(hs, e5, label='central')
ax.legend()