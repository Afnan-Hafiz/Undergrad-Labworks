...
Original file is located at
    https://colab.research.google.com/drive/1UB-NQl6be9iyRpsIj1BjdeK-tA0CHfoF
"""
...
'''
Suppose you have four nodes(-0.65,1.73), (0.56, 1.93), (1.5, 2.74), (-0.79, 1.42)
Using Vandermonde Matrix method, print out the value of the interpolating polynomial at x=7.
You have to solve the given problem using above implemented get_poly() method.
'''

dataX=np.array([-0.65,0.56,1.5,-0.79])
dataY=np.array([1.73,1.93,2.74,1.42])
x=7
a=get_poly(dataX, dataY)
print(a(x))