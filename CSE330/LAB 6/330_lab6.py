...
Original file is located at
    https://colab.research.google.com/drive/1g1ImfBBmPPxT5CiB-zfUQhHkmCxg3mhV
...
f = Polynomial([2.0, 1/2, -6.0, -2.0, 2.5, 1.0])
g3 = Polynomial([-2.0, -1/2, 6.0, 2.0, 0, -1.0])
def g3(x):
    p = Polynomial([-2.0, -1/2, 6.0, 2.0, 0, -1.0])
    return np.power(p(x)/2.5, 1.0/4.0)
...
if len(g3_a) > 0:
    root = np.array([g3_a[len(g3_a)-1]])
    plt.plot(root, f(root), 'ko')

print(pd.DataFrame({'g3(x))':g3_a,}))